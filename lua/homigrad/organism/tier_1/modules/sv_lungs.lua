...
local lowoxy = {
	"Я сейчас упаду в обморок... Кислорода не хватает.",
	"Кислорода мало... Я долго не протяну...",
	"Мне срочно нужен свежий воздух...",
	"Я задыхаюсь...",
	"Нужен воздух... или я прямо тут отрублюсь..."
}
...
local not_enough_intake = {
	...
	//"Отдохнуть звучит как хорошая идея.",
	"Мне нужно дышать...",
	"Мне тяжело дышать...",
}
...
local drop_mask = {
	...
	"Это просто отвратительно... и я точно не могу в этом дышать...",
	"Воняет пиздец... Надо снять эту маску...",
}

local drugged = {
	"Ооо хо-хо-хоооо, мн-не нрааавится.....",
	"Оххеренно..... чччууувствую себя ооотлично..",
	"Вот эт-то ввееещь, чувааак",
	"Мне тааак нравится то, ччТО БЫ я сейчас ни чувствовал....",
	"О дааа, кааайф!",
	"Хочу чувствовать сэбя так всссю ОСТАВШУЮСЯ жизнь",
	"Зачем я вообще здесь?.. д-да пофиг, уххх хех",
	"Ктооо ты? Валиии отсюда...",
	"Больше ничего не хочу... это идЕЕЕально!.."
}
...
module[2] = function(owner, org, timeValue)
	...
	if org.isPly and not org.otrub and o2.curregen < losing_oxy and org.analgesia <= 1.5 and !org.heartstop then
		if mask_blevota then
			if o2[1] < 15 then
				org.owner:Notify("СНИМИ ЭТУ ГРЕБАНУЮ МАСКУ", 25, "take_gasmask2", 0, nil, color_red2)
			else
