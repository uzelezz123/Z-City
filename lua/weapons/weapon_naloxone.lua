...
SWEP.PrintName = "Налоксон"
SWEP.Instructions = "Препарат, предназначенный для нейтрализации последствий опиоидной передозировки.\n\nНажмите ПКМ, чтобы ввести его другому человеку."
