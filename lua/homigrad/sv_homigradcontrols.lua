local hg_allow_homigrad = ConVarExists("hg_allow_homigrad") and GetConVar("hg_allow_homigrad") or CreateConVar("hg_allow_homigrad",1,FCVAR_SERVER_CAN_EXECUTE,"allow homigrad draging entites",0,1)
