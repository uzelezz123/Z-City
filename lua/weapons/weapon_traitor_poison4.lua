...
SWEP.PrintName = "Флакон с кураре"
SWEP.Instructions = "Кураре становится активным только при попадании в рану или непосредственно в кровоток; яд не действует при приеме внутрь. Этот токсин вызывает расслабление и слабость скелетных мышц, а при введении достаточной дозы приводит к смерти от удушья (асфиксии) в результате паралича диафрагмы."
